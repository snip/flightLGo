...
## Check activity
flightLGo will output to the terminal it is started in.
...
The website will only show your airport when at least one takeoff or landing event has been watched and reported to it.
